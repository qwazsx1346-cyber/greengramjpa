...
public class UserFollowController {
    ...
    @DeleteMapping
    public ResultResponse<?> deleteFollow(@AuthenticationPrincipal UserPrincipal userPrincipal
        ...
        userFollowService.deleteFollow( req );
        return new ResultResponse<>("팔로우 삭제 완료", null);
    }
}
